...
SECRET_KEY = 'django-insecure-yxozc*e(c$k$evy8)*)k5!)7s+a^4)4bdpv$^*3$ug3&hs*(ei'
...
# config to tell Django to use our new custom user model instead of the built-in User model. 
